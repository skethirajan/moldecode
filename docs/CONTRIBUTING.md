...
uv venv $SCRATCH/venvs/moldecode

# Activate and install
source $SCRATCH/venvs/moldecode/bin/activate
uv pip install -e ".[dev]"
...
# Run with coverage
pytest --cov=moldecode --cov-report=html
...
- Mirror the source structure (e.g., `src/moldecode/utils.py` → `tests/test_utils.py`).
